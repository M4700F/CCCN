...
def create_global_evaluate(aggregator: str, dataset: str, num_channels: int):
    ...
    def global_evaluate(server_round: int, arrays: ArrayRecord) -> MetricRecord:
        ...
        test_dataloader = load_centralized_dataset(dataset=dataset)
