...
echo "✓ Completed: freerider_cifar10_iid_fedmedian.csv"
echo ""
...
echo "✓ Completed: freerider_cifar10_iid_fedtrimmedavg.csv"
echo ""
...
echo "✓ Completed: freerider_cifar10_noniid_fedmedian.csv"
echo ""
...
echo "✓ Completed: freerider_cifar10_noniid_fedtrimmedavg.csv"
echo ""
